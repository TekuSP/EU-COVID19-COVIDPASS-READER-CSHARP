...
//
//    var manufacturers = Manufacturers.FromJson(jsonString);
...
namespace CovidPassTestReader.CovidPass.Json
{
    ...
    public partial class Manufacturers
    {
        ...
        public static Manufacturers FromJson(string json) => JsonConvert.DeserializeObject<Manufacturers>(json, CovidPassTestReader.CovidPass.Json.Converter.Settings);
